...
config=config/ablation_4/xs_4_1a_cross_pointnet_noff.yaml
weights=checkpoints/xs_4_1a_cross_pointnet_impcgf_4ch_noff/last.ckpt
...
python object_gen_eval_impcfg.py -c $config -w $weights -n xs_4_1a_cross_pointnet_noff_4ch_eval_14_a -e 1 -t interpolate -cls None -ind 14

config=config/ablation_4/xs_4_1a_cross_pointnet_reordered.yaml
weights=checkpoints/xs_4_1a_cross_pointnet_impcgf_4ch_reordered/last.ckpt
python object_gen_eval_impcfg.py -c $config -w $weights -n xs_4_1a_cross_pointnet_reordered_eval_14_a -e 1 -t interpolate -cls None -ind 14
